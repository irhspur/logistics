...
<?php echo $this->Form->create('Logistic'); ?>
	<fieldset>
		<legend><?php echo __('Edit Logistic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Logistic.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Logistic.id'))); ?></li>
