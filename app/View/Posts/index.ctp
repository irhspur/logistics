        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($posts as $Post): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $Post['Post']['id'], $current_user['id'], $current_user['branch_id'])); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $Post['Post']['id'], $current_user['id'], $current_user['branch_id']), array(), __('Are you sure you want to delete # %s?', $Post['Post']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
