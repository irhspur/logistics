<div class="Users index">
    ...
    <h2><?php echo __('Approved Purchases'); ?></h2>
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($purchases as $purchase): ?>
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Form->postLink(__('Dispatch Purchase'), array('controller' => 'dispatches', 'action' => 'add', $purchase['Purchase']['id']), array(), __('Are you sure you want to dispatch purchase # %s?', $purchase['Purchase']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
